 ...
 * Custom google font
 */
$custom_body_font = get_theme_mod('custom_body_font');
$custom_body_font = str_replace(' ', '+', $custom_body_font); // replace space with +
$custom_headline_font = get_theme_mod('custom_headline_font');
$custom_headline_font = str_replace(' ', '+', $custom_headline_font); // replace space with +
$custom_google_font_string = 'https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500&display=swap';

if ($custom_body_font !== $custom_headline_font) {
    $custom_google_font_string = 'https://fonts.googleapis.com/css2?family=' . $custom_body_font .
        ':wght@300;400;500&family=' . $custom_headline_font . ':wght@300;400;500&display=swap';
} else {
    $custom_google_font_string = 'https://fonts.googleapis.com/css2?family=' . $custom_body_font .
...
function frontend_css() {
    ...
    global $custom_google_font_string,
           $max_container_width,
    ...
    ?>
        ...
        <style>
            ...
            body {
                font-family: '<?php echo $custom_body_font; ?>', sans-serif;
            }
    ...
    ?>
        <style>
            ...
            .editor-styles-wrapper {
                font-family: '<?php echo $custom_body_font; ?>', sans-serif !important;
            }
...
add_action('admin_head', 'editor_css');
